...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Assign tasks, mention teammates, track progress together.',
    tag: 'TEAMWORK',
  },
  {
    icon: (
    ...
    desc: 'Velocity charts, burndown graphs, performance insights.',
    tag: 'INSIGHTS',
  },
  {
    icon: (
    ...
    title: 'Built-in Chat',
    desc: 'Conversations live right next to the work.',
    tag: 'CONNECT',
  },
]
      ...
      <div className="lp-root">
        ...
        <div className="lp-showcase">
          ...
          <div className="lp-showcase-inner">
            ...
            <div className="lp-window-card">
              <div className="lp-window-bar">
                <span className="lp-dot lp-dot--red" />
                <span className="lp-dot lp-dot--yellow" />
                <span className="lp-dot lp-dot--green" />
                <span className="lp-window-title">northwind.workspace</span>
              </div>
            ...
            <div className="lp-stats">
              ...
              <div className="lp-sticker">
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                  <rect x="1" y="1" width="34" height="34" rx="8" fill="#ddeedd" stroke="#7a9e7e" strokeWidth="2"/>
                  <path d="M10 18h16M18 10v16" stroke="#4e7252" strokeWidth="2.5" strokeLinecap="round"/>
                  <circle cx="18" cy="18" r="5" stroke="#4e7252" strokeWidth="2"/>
                </svg>
